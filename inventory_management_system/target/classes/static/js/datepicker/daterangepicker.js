!function (t, e) {
    ...
    s.prototype = {
        constructor: s, setOptions: function (t, e) {
            ...
            var e, s, n = i(t.target).attr("data-title"), r = n.substr(1, 1), o = n.substr(3, 1),
            ...
            var o, h = a([e, t]).daysInMonth(), l = a([e, t, 1]), c = a([e, t, h]),
                d = a(l).subtract(1, "month").month(), f = a(l).subtract(1, "month").year(),
                m = a([f, d]).daysInMonth(), p = l.day(), u = [];
